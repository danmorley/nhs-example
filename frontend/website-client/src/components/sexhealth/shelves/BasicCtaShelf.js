...
//       //
//       // NOTE: Temporary solution until promo_panel (v1) can be removed.
//       content.heading = content.banner.heading;
//       content.shelf_id = content.banner.shelf_id;
//       content.meta_variant = content.banner.meta_variant;
//       content.meta_layout = content.banner.meta_layout;
