...
class Page extends Component {
  ...
  renderPageContent(page, site) {
    ...
    var shelves = body.map((shelf, i) => {
      ...
      if (ShelfClass) {
        return (<ErrorBoundary><ShelfClass key={i} content={shelf.value} id={shelfId} site={site} classNamePrefix={shelfClassNamePrefix} variant={shelfVariant} layout={shelfLayout}/></ErrorBoundary>);
      } else {
