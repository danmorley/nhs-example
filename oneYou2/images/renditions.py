...
MOBILE_RENDITION_CHOICES = (
    ...
    ('188x176', '188 x 176'),
    ('305x120', '305 x 120'),
    ('320x540', '320 x 540 Sexhealth home page header'),
    ('345x160', '345 x 160'),
    ('360x180', '360 x 180 Sexhealth teaser'),
    ('375x143', '375 x 143'),
    ('375x200', '375 x 200 Sexhealth page header, banner/promo background'),
    ('375x256', '375 x 256'),
    ('375x307', '375 x 307'),
)
...
DESKTOP_RENDITION_CHOICES = (
    ...
    ('650x450', '650 x 450'),
    ('720x263', '720 x 263'),
    ('1366x591', '1366 x 591 Sexhealth home page header background'),
    ('1440x240', '1440 x 240'),
    ('1440x309', '1440 x 309'),
    ('1440x366', '1440 x 366 Sexhealth page header, banner/promo background'),
    ('1440x800', '1440 x 800'),
    ('1150x220', '1150 x 220'),
)